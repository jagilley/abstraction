...
3. ~~**OOD adaptation post-ratchet**~~: *Done* — see [OOD_GATE_README](OOD_GATE_README.md#experiment-4-ood-adaptation-after-gated-ratchet-2026-06-20). WS_LG ≈ WS_UG_uniform: +8pp zero-shot OOD at 45° (tracks distillation), ~25% faster adaptation speed (upgrading prior null result). The two ratchet conditions produce nearly identical OOD behavior despite opposite gate mechanisms (FOMAML opens to 0.77, unified closes to 0.13) — the val loss improvement is genuine generalization.
