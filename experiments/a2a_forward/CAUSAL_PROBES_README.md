...
modal run a2a_forward/novelty_probe.py $COMMON
modal run a2a_forward/novelty_steer.py $COMMON
modal run a2a_forward/injection_help.py $COMMON
modal run a2a_forward/injection_help_structural.py $COMMON
```
