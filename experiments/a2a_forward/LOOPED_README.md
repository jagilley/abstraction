...
3. **Chase the cancellation signature.** Its absence here (summation/amplification) is a real gap between this model and the biology; does *any* regime (damping, higher gate, deeper core, an explicit cancellation head) produce corollary-discharge? Ties directly to the robustness inversion.
