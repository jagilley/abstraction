...
**Full writeup**: [reaching/ACTIVE_VISION_README.md](reaching/ACTIVE_VISION_README.md) | **Status**: observational half done (single seed)
...
**Full writeup**: [reaching/REACHING_INTERNAL_README.md](reaching/REACHING_INTERNAL_README.md) | **Status**: done, positive + sharpened diagnosis (single seed × MNIST + Fashion, both agree)
...
**Full writeup**: [reaching/REACHING_LOOKAHEAD_README.md](reaching/REACHING_LOOKAHEAD_README.md) | **Status**: done, positive-with-a-dissociation (single seed × {obstacles, maze} × MNIST; perfect-sim control done)
...
**Full writeup**: [CANCELLATION_README.md](CANCELLATION_README.md) | **Status**: done, single seed (Fashion), closes LOOPED next-step #3
...
**Full writeup**: [confabulation/README.md](confabulation/README.md) | **Status**: done, single seed — positive on the core dissociation, **null on loop-necessity, and that null disagrees with the RHM sibling**
