...
- **Firm up the self-tuning** (a coarse bandit / successive-halving outer optimizer), and try a genuinely ballistic, non-re-groundable controller where the FM gap might transmit to control.
