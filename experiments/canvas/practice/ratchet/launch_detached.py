"""Session-isolated launcher for detached Modal runs (canvas/plant/launch_detached.py, retargeted to this node).
...
Usage (from experiments/):
    python3 canvas/practice/ratchet/launch_detached.py --fn run --tag cr_s0
Logs go to canvas/practice/ratchet/results/launch_<tag>.log, or to --logdir.
...
def main():
    ...
    cmd = ["modal", "run", "--detach", "-m", f"canvas.practice.ratchet.ratchet::{fn}"] + args
