...
**Sibling / origin**: the reaching-control arity line in a2a_forward — [ACTIVE_VISION_README.md](../a2a_forward/reaching/ACTIVE_VISION_README.md), [REACHING_INTERNAL_README.md](../a2a_forward/reaching/REACHING_INTERNAL_README.md) — and the idea doc [self_model_needs_a_loop.md](../../ideas/self_model_needs_a_loop.md).
