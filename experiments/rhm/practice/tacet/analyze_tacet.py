...
def main():
    ...
    ap.add_argument("--tag", default="tc_s0")             # [tacet]
    ap.add_argument("--gf-tag", default="tc_gf")          # [tacet]
...
BASE = "outer_yield_m4"          # the ungated baseline == grade-only selection
