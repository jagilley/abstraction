"""Session-isolated launcher for detached Modal runs (`ear`'s, retargeted at `recital`).
...
Usage (from experiments/):
    python3 rhm/practice/recital/launch_detached.py --fn recital --tag rc_s0 [extra modal args]

Logs go to rhm/practice/recital/results/launch_<tag>.log.
"""
...
def main():
    ...
    cmd = ["modal", "run", "--detach", f"rhm/practice/recital/recital.py::{fn}"] + args
