"""Session-isolated launcher for detached Modal runs (`recital`'s, retargeted at `tall`).
...
Usage (from experiments/):
    python3 rhm/practice/tall/launch_detached.py --fn tall --tag tl_s0 [extra modal args]

Logs go to rhm/practice/tall/results/launch_<tag>.log.
"""
...
def main():
    ...
    cmd = ["modal", "run", "--detach", f"rhm/practice/tall/tall.py::{fn}"] + args
