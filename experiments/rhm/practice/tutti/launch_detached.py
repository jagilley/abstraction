"""Session-isolated launcher for detached Modal runs (caesura/'s, retargeted).
...
Logs go to rhm/practice/tutti/results/launch_<tag>.log.
"""
...
def main():
    ...
    cmd = ["modal", "run", "--detach", f"rhm/practice/tutti/tutti.py::{fn}"] + args
