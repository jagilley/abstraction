...
Usage (from experiments/):
    python3 rhm/practice/ratchet/launch_detached.py --fn ratchet --tag rr_s0 [extra modal args...]

Logs go to rhm/practice/ratchet/results/launch_<tag>.log.
"""
...
def main():
    ...
    cmd = ["modal", "run", "--detach", f"rhm/practice/ratchet/ratchet.py::{fn}"] + args
