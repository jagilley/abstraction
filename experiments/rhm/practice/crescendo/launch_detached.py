...
Logs go to rhm/practice/crescendo/results/launch_<tag>.log.
"""
...
def main():
    ...
    cmd = ["modal", "run", "--detach", f"rhm/practice/crescendo/crescendo.py::{fn}"] + args
