"""Session-isolated launcher for detached Modal runs (intonation/'s, retargeted).
...
Logs go to rhm/practice/ostinato/results/launch_<tag>.log.
"""
...
def main():
    ...
    cmd = ["modal", "run", "--detach", f"rhm/practice/ostinato/ostinato.py::{fn}"] + args
