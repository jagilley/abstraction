"""Session-isolated launcher for detached Modal runs (tutti/'s, retargeted).  # [inflection]
...
Usage (from experiments/):
    python3 rhm/practice/inflection/launch_detached.py --fn inflection_run --tag if_s0 ...

Logs go to rhm/practice/inflection/results/launch_<tag>.log.
"""
...
def main():
    ...
    cmd = ["modal", "run", "--detach", f"rhm/practice/inflection/inflection.py::{fn}"] + args
