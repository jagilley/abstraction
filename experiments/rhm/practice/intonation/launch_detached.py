"""Session-isolated launcher for detached Modal runs (tacet/'s, retargeted).
...
Logs go to rhm/practice/intonation/results/launch_<tag>.log.
"""
...
def main():
    ...
    cmd = ["modal", "run", "--detach", f"rhm/practice/intonation/intonation.py::{fn}"] + args
