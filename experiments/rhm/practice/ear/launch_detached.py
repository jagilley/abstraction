"""Session-isolated launcher for detached Modal runs (the ratchet's, retargeted at `ear`).
...
Usage (from experiments/):
    python3 rhm/practice/ear/launch_detached.py --fn ear --tag er_s0 [extra modal args...]

Logs go to rhm/practice/ear/results/launch_<tag>.log.
"""
...
def main():
    ...
    cmd = ["modal", "run", "--detach", f"rhm/practice/ear/ear.py::{fn}"] + args
