"""Session-isolated launcher for detached Modal runs (the etude's plasticity_gain fix).
...
Usage (from experiments/):
    python3 rhm/practice/crystallize/launch_detached.py --tag cg_s0 --seed 0 [extra modal args...]

Logs go to rhm/practice/crystallize/results/launch_<tag>.log.
"""
...
def main():
    ...
    cmd = ["modal", "run", "--detach",
           f"rhm/practice/crystallize/crystallize.py::{fn}"] + args
