...
Usage (from experiments/):
    python3 rhm/practice/antiphon/launch_detached.py --fn antiphon_run --tag cr3_s0 ...

Logs go to rhm/practice/antiphon/results/launch_<tag>.log.
"""
...
def main():
    ...
    cmd = ["modal", "run", "--detach", f"rhm/practice/antiphon/antiphon.py::{fn}"] + args
