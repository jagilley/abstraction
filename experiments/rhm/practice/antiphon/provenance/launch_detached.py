"""Session-isolated launcher for detached Modal runs (handle/'s, retargeted).
...
Usage (from experiments/):
    python3 rhm/practice/antiphon/provenance/launch_detached.py \
        --fn antiphon_p_run --tag ap_s0 ...

Logs go to rhm/practice/antiphon/provenance/results/launch_<tag>.log.
"""
...
def main():
    ...
    cmd = ["modal", "run", "--detach",
           f"rhm/practice/antiphon/provenance/antiphon_p.py::{fn}"] + args
