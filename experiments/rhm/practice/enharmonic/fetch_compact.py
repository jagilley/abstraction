...
Usage (from experiments/):
    python3 rhm/practice/enharmonic/fetch_compact.py --tag en_s0 --fetch --replace
    python3 rhm/practice/enharmonic/fetch_compact.py --tag en_smoke --replace   # no re-fetch
"""
