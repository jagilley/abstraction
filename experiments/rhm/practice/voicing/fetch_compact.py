"""[voicing] (`enharmonic`'s, copied and retargeted)
...
Usage (from experiments/):
    python3 rhm/practice/voicing/fetch_compact.py --tag en_s0 --fetch --replace
    python3 rhm/practice/voicing/fetch_compact.py --tag en_smoke --replace   # no re-fetch
"""
