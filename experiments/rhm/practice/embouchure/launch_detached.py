"""Session-isolated launcher for detached Modal runs (inflection/'s, retargeted).  # [embouchure]
...
Usage (from experiments/):
    python3 rhm/practice/embouchure/launch_detached.py --fn embouchure_run --tag em_s0 ...

Logs go to rhm/practice/embouchure/results/launch_<tag>.log.
"""
...
def main():
    ...
    cmd = ["modal", "run", "--detach", f"rhm/practice/embouchure/embouchure.py::{fn}"] + args
