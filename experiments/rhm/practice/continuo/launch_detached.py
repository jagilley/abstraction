"""Session-isolated launcher for detached Modal runs (`intonation/launch_detached.py`'s,
retargeted at `corridor.py`).
...
Logs go to rhm/practice/continuo/results/launch_<tag>.log.
"""
...
def main():
    ...
    cmd = ["modal", "run", "--detach", f"rhm/practice/continuo/corridor.py::{fn}"] + args
