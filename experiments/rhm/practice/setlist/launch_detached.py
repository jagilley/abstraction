"""Session-isolated launcher for detached Modal runs (`transpose`'s, retargeted at `setlist`).
...
Usage (from experiments/):
    python3 rhm/practice/setlist/launch_detached.py --fn setlist --tag tp_s0 [modal args]

Logs go to rhm/practice/setlist/results/launch_<tag>.log.
"""
...
def main():
    ...
    cmd = ["modal", "run", "--detach", f"rhm/practice/setlist/setlist.py::{fn}"] + args
