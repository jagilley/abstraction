...
def main():
    ...
    ap.add_argument("--tag", default="ca_s0")             # [caesura]
    ap.add_argument("--gf-tag", default="ca_gf")          # [caesura]
    ...
    if a.floors:
        print(f"=== caesura — in-tag floors, tag {a.tag} ===")
        in_tag_floors(a.tag, A, setup, summary)
        return
    gf = _load(os.path.join(FIG, a.gf_tag), "gate.json")
    print(f"=== caesura (E\u2032 round 3, delta-silence as the commit decision) — tag {a.tag} ===")
...
TREAT, CEIL, SCHED, EXT = "dsil_yield", "ceiling_m3", "dsil_sched", "outer_yield_m4x"
