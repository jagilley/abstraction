...
app = modal.App("rhm-practice-caesura", image=image)        # [caesura]
REMOTE = "rhm_practice_caesura"                              # [caesura]
            ...
            if spec["commit"] and active <= commit_maxl and committed.get(active) is None:
                ...
                if spec["commit"] == "delta":
                    ...
                    prov = not lic
                      ...
                      and getattr(loop, "read_key", None) == "dsil"
...
def caesura_run(                                           # [caesura]
    tag: str = "ca_s0",
    arms: str = CAESURA_ARMS,
...
def preflight(cycles: int = 2, eras: str = "1:25:6,2:12:6,3:6:5,4:3:5,5:1:5",
    ...
    ARM_SWEEP = ("dsil_sched", "dsil_yield", "dsil_read", "dsil_and",
...
def main(quick: bool = True):
    caesura_run.remote(quick=quick)
