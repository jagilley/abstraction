...
Logs go to rhm/practice/conductor/results/launch_<tag>.log.
"""
...
def main():
    ...
    cmd = ["modal", "run", "--detach", f"rhm/practice/conductor/conductor.py::{fn}"] + args
