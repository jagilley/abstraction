...
- **The practice arc on RHM**: [`practice/`](practice/README.md) — practice as a control loop over the *conditions and units* of learning, ported from [`mjc/practice/`](../mjc/practice/README.md). Child: [`practice/crystallize/`](practice/crystallize/README.md) (certificate-gated compilation under priced feedback).
