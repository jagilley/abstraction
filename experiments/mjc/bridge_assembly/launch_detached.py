...
Usage (from experiments/):
    python3 mjc/bridge_assembly/launch_detached.py --tag asm_s0 --seed 0 [extra modal args...]

Logs go to mjc/bridge_assembly/figures/launch_<tag>.log; the client exits once the
...
def main():
    ...
    log_path = os.path.join(HERE, "figures", f"launch_{tag}.log")
    cmd = ["modal", "run", "--detach",
           "mjc/bridge_assembly/bridge_assembly.py::bridge_assembly"] + args
