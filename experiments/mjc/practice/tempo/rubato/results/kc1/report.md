# rubato / kc1 — Phase 1: the ceiling of the factored program

seed 0 · R* 0.16 · tempi [32, 16, 8, 2] · Delta 5 (120 ms) · app=fixed · 1729s (library 574 · kin 1 · sweep 548)
complete=True
...
| H | analytic kp | analytic kd | chosen multiplier | kp | kd | e_piece | kp edge | kd edge |
|---|---|---|---|---|---|---|---|---|
...
|---|---|---|---|---|---|
| 32 | 1 | **2** (R=16) 0.0148 | **2** (R=16) 0.0204 | 0.0522* | 0.0399* |
| 32 | 2 | **4** (R=16) 0.0433 | **4** (R=16) 0.0486 | 0.0997 | 0.0872 |
| 32 | 3 | **8** (R=16) 0.0373 | **8** (R=16) 0.0438 | 0.0604* | 0.0803 |
| 32 | 4 | **16** (R=16) 0.0214 | **16** (R=16) 0.0246 | 0.0627 | 0.0839 |
| 16 | 1 | **1** (R=16) 0.0582 | **1** (R=16) 0.0551 | 0.1202 | 0.0776 |
| 16 | 2 | **2** (R=16) 0.0609 | **2** (R=16) 0.0423 | 0.0694 | 0.0339* |
| 16 | 3 | **4** (R=16) 0.0571 | **4** (R=16) 0.0566 | 0.0673 | 0.0498* |
| 16 | 4 | **8** (R=16) 0.0368 | **8** (R=16) 0.0519 | 0.0821 | 0.0719 |
| 8 | 1 | **2** (R=4) 0.0429 | **8** (R=1) 0.0433 | 0.1420 | 0.1285 |
| 8 | 2 | **4** (R=4) 0.0402 | **4** (R=4) 0.0476 | 0.0564* | 0.0545* |
| 8 | 3 | **2** (R=16) 0.0610 | **2** (R=16) 0.0589 | 0.0555* | 0.0587* |
| 8 | 4 | **4** (R=16) 0.0540 | **4** (R=16) 0.0595 | 0.0574* | 0.0498* |
| 2 | 1 | x | x | 0.2950 | 0.2919 |
| 2 | 2 | x | x | 0.1260 | 0.0846 |
| 2 | 3 | x | x | 0.1398 | 0.1167 |
| 2 | 4 | x | x | 0.1160 | 0.0938 |

### The full read ladder (exact FM, `e_piece`, reads per span in brackets)

| H | L | R=1 | R=2 | R=4 | R=8 | R=16 |
|---|---|---|---|---|---|---|
| 32 | 1 | 0.0146* [32] | 0.0145* [16] | 0.0149* [8] | 0.0107* [4] | 0.0148* [2] |
| 32 | 2 | 0.0422* [64] | 0.0422* [32] | 0.0426* [16] | 0.0422* [8] | 0.0433* [4] |
| 32 | 3 | 0.0382* [128] | 0.0374* [64] | 0.0392* [32] | 0.0399* [16] | 0.0373* [8] |
| 32 | 4 | 0.0223* [256] | 0.0216* [128] | 0.0232* [64] | 0.0237* [32] | 0.0214* [16] |
| 16 | 1 | 0.0164* [16] | 0.0202* [8] | 0.0198* [4] | 0.0278* [2] | 0.0582* [1] |
| 16 | 2 | 0.0424* [32] | 0.0442* [16] | 0.0453* [8] | 0.0446* [4] | 0.0609* [2] |
| 16 | 3 | 0.0441* [64] | 0.0464* [32] | 0.0473* [16] | 0.0473* [8] | 0.0571* [4] |
| 16 | 4 | 0.0293* [128] | 0.0313* [64] | 0.0319* [32] | 0.0317* [16] | 0.0368* [8] |
| 8 | 1 | 0.0288* [8] | 0.0326* [4] | 0.0429* [2] | 0.0889 [1] | 0.0889 [1] |
| 8 | 2 | 0.0323* [16] | 0.0332* [8] | 0.0402* [4] | 0.0780 [2] | 0.0792 [1] |
| 8 | 3 | 0.0402* [32] | 0.0415* [16] | 0.0442* [8] | 0.0557* [4] | 0.0610* [2] |
| 8 | 4 | 0.0262* [64] | 0.0273* [32] | 0.0258* [16] | 0.0396* [8] | 0.0540* [4] |
| 2 | 1 | 0.1105 [2] | 0.2988 [1] | 0.2988 [1] | 0.2988 [1] | 0.2988 [1] |
| 2 | 2 | 0.1639 [4] | 0.2077 [2] | 0.2036 [1] | 0.2036 [1] | 0.2036 [1] |
| 2 | 3 | 0.1401 [8] | 0.1306 [4] | 0.1111 [2] | 0.1120 [1] | 0.1120 [1] |
| 2 | 4 | 0.1137 [16] | 0.1053 [8] | 0.1205 [4] | 0.1235 [2] | 0.1796 [1] |

### (c) `reflex_ec` beside the R = 1 row, and the oracle-feedforward control

| H | reflex (fb) | reflex_ec | reflex_ec0 | cor R=1 L1 (fb) | L4 (fb) | oracle-ff R=1 L1 | L4 |
|---|---|---|---|---|---|---|---|
...
| 2 | 0.0690 (16) | 0.1219 | 0.0320 | 0.1105 (16) | 0.1137 (16) | 0.1063 | 0.1025 |
...
| H | L | R=1 | R=4 | R=16 | open |
|---|---|---|---|---|---|
| 32 | 1 | 0.0146 / 0.0163 / 0.0216 / 0.0676 | 0.0149 / 0.0171 / 0.0227 / 0.0685 | 0.0148 / 0.0168 / 0.0245 / 0.0691 | 0.0370 / 0.0398 / 0.0439 / 0.1001 |
| 32 | 4 | 0.0223 / 0.0231 / 0.0285 / 0.0687 | 0.0232 / 0.0242 / 0.0301 / 0.0691 | 0.0214 / 0.0227 / 0.0302 / 0.0700 | 0.0213 / 0.0255 / 0.0359 / 0.0876 |
| 16 | 1 | 0.0164 / 0.0176 / 0.0196 / 0.0361 | 0.0198 / 0.0212 / 0.0215 / 0.0378 | 0.0582 / 0.0562 / 0.0613 / 0.0869 | 0.0582 / 0.0562 / 0.0613 / 0.0869 |
| 16 | 4 | 0.0293 / 0.0295 / 0.0311 / 0.0461 | 0.0319 / 0.0320 / 0.0334 / 0.0454 | 0.0368 / 0.0372 / 0.0389 / 0.0527 | 0.0750 / 0.0757 / 0.0743 / 0.0775 |
| 8 | 1 | 0.0288 / 0.0286 / 0.0259 / 0.0258 | 0.0429 / 0.0404 / 0.0524 / 0.0935 | 0.0889 / 0.0920 / 0.0928 / 0.0970 | 0.0889 / 0.0920 / 0.0928 / 0.0970 |
| 8 | 4 | 0.0262 / 0.0263 / 0.0266 / 0.0290 | 0.0258 / 0.0259 / 0.0262 / 0.0291 | 0.0540 / 0.0540 / 0.0543 / 0.0575 | 0.1073 / 0.1073 / 0.1077 / 0.1209 |
| 2 | 1 | 0.1105 / 0.1106 / 0.1108 / 0.1164 | 0.2988 / 0.2983 / 0.2975 / 0.2939 | 0.2988 / 0.2983 / 0.2975 / 0.2939 | 0.2988 / 0.2983 / 0.2975 / 0.2939 |
| 2 | 4 | 0.1137 / 0.1122 / 0.1150 / 0.1127 | 0.1205 / 0.1211 / 0.1202 / 0.1245 | 0.1796 / 0.1798 / 0.1793 / 0.1798 | 0.1796 / 0.1798 / 0.1793 / 0.1798 |

**ε at which the band is spent:**
...
| 16 | 4 | >0.2 | >0.2 | >0.2 | already |
| 8 | 1 | >0.2 | 0.082 | already | already |
| 8 | 4 | >0.2 | >0.2 | >0.2 | already |
| 2 | 1 | already | already | already | already |
| 2 | 4 | already | already | already | already |
