...
Logs go to mjc/practice/priced_plasticity/results/launch_<tag>.log; the client exits once
the detached app is submitted, and the run continues server-side.
"""
...
def main():
    ...
    cmd = ["modal", "run", "--detach",
           "mjc/practice/priced_plasticity/priced_plasticity.py::priced"] + args
